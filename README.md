# 👋 Hola, soy Jenny Julizza Álava Bolaños
...
- Experiencia en proyectos empresariales y académicos
...
- **Lenguajes:** Python, PHP, JavaScript, C/C++, SQL, MATLAB
- **Backend:** Node.js, Django
- **Frontend:** HTML5, CSS3, Bootstrap, Vue.js
- **Mobile:** NativeScript, PhoneGap
- **CMS:** WordPress (PSD to WordPress)

### ⚙️ Sistemas, redes y hardware
- Redes: LAN, WAN, WLAN, MAN, SAN
- Protocolos: TCP/IP, VoIP, CCTV, telefonía IP
- Telecomunicaciones: fibra óptica, RF, microondas
- Hardware & IoT: Arduino, ESP8266, Raspberry Pi, FPGA
...
- 🧾 Consumo de APIs REST (facturación electrónica)
- 🌐 Desarrollo web y backend
- 📊 Dashboards y pruebas funcionales
- 🧪 Testing y análisis de sitios web
